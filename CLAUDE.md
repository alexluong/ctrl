...
- `docs` — ideas, project discussions, cross-domain notes; `docs/machine.md` = machine/repo layout; `docs/workflow.md` = how Claude works across repos (session modes, git/commit conventions, quality bar); `docs/projects/<name>.md` = each project's living doc
