...
## League (per Alex, 2026-09-06; assumptions unconfirmed)

- 8 teams, snake, Alex picks 6th (slots 6, 11, 22, 27, 38, 43, 54, 59, 70, 75, 86, 91, ...)
- Half PPR
- 2 starting QBs (assumed both mandatory, not superflex)
- Lineup assumed QB QB RB RB WR WR TE FLEX K DEF
- Alex preference: Alabama-alumni lean, not absolute. Don't reach more than ~10 picks past ADP except for Hurts.

## Strategy notes

- 2QB + 8 teams: 16 starting QBs drafted, QB is the scarce asset. RB/WR deep, waivers rich.
- Plan: QB at 6 (Lamar/Burrow/Maye), Hurts at 11 if there (else Henry), QB2 by pick 27, Jameson + DeVonta at 38/43, Waddle at 54/59, Bryce Young QB3 at 70/75, TE (Bowers/McBride) ~rd 9-10.

## Alabama alumni, 2026 (2QB ADP from fantasyfootballcalculator, Sep 2026)

| Player | Pos | Team | ADP | Verdict |
|---|---|---|---|---|
| Jahmyr Gibbs | RB | DET | 1 | consensus #1, gone |
| Derrick Henry | RB | BAL | 10 | target at 11; age 32, no catches |
| Jalen Hurts | QB | PHI | 16 | priority; only Bama reach worth making |
| Jameson Williams | WR | DET | 51 | target 38/43 |
| DeVonta Smith | WR | PHI | 58 | target 43; WR1 after AJ Brown traded to NE |
| Jaylen Waddle | WR | DEN | 69 | best value; traded to DEN, Payton/Nix |
| Bryce Young | QB | CAR | 82 | QB3 at 70/75; confirmed starter |
| Tua Tagovailoa | QB | ATL | undrafted | flier only if named Wk1 starter; Penix's job to lose |
| Brian Robinson Jr. | RB | ATL | undrafted | Bijan handcuff |
| Jerry Jeudy | WR | CLE | 129 | last round only |
| Calvin Ridley | WR | TEN | 135 | last round only |
| Josh Jacobs | RB | GB | 120 | avoid: commissioner exempt list |
| Najee Harris | RB | NYG | - | avoid: RB4, post-Achilles |
