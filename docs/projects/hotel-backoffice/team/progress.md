...
- **Vietnamese wording wanted from you** (no rush; dev has marked placeholders): the words a desk uses for "own bill" vs "master folio" (group booking routing, company screen).
