...
- Money role split is now concrete (D-17 built note): receptionist posts charges, takes payments, transfers to receivable; owner alone voids, refunds, writes off, records expenses. Say if you want the line elsewhere.
