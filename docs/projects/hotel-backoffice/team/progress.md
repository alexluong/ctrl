...
- **Flow recordings (your 2026-09-24 call)**: QA recording R1 desk walk-in, R2 owner morning as samples; I send you the files. Screen drawings paused (HTML template at artifact FnYDkwHfpSed7wtQmzgL3L if we return to it); ezFolio-look-alike demo variant = parked, mockups first if pursued.
