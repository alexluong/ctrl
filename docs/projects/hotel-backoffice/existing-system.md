...
- **Do not plan migration around ezFolio's Excel export — it is broken** (truncates at the first `#`). Plan on HTML scraping or a vendor DB export. Decide before schema work goes deep.
