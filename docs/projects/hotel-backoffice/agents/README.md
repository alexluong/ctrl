...
Each SoLex session is a named Claude Code agent with a dir here: `agents/<name>/README.md` = profile (role, owned files, current objective, log), `agents/<name>/notes.md` = personal scratch (owner-only). Shared notes across agents: `../team/` (decisions, questions, log).

**Session start: read your profile, your notes, `../README.md`, `../team/log.md`.** Architect updates "Current objective"; agents append to their Log + notes.
...
- **Questions** for Alex/client → `../team/questions.md`. **Handoffs / done-notices** → `../team/log.md` (newest first). Personal thinking → your `notes.md`.
