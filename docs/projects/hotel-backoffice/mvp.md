...
- **Early check-out** (review B1, 2026-09-25): nights are [arrival, departure) on business dates; check-out on day D drops every night ≥ D including the current one and reverses today's posted room line in the same batch. **Minimum one night**: a stay that checked in always keeps its arrival night, so a same-day in/out pays one night (the room was used; day-use pricing is out of scope). Early check-out only drops nights after the arrival night. Late check-out fee = catalogue item; past the next roll = an extra night.
