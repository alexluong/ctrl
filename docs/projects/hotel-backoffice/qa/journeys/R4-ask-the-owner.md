...
**Purpose:** a receptionist cannot change money on her own. She asks, the owner decides from one card, and the answer comes back to the line.
**Personas:** Linh, a real receptionist account; Mai, owner.
**Seed used:** 101 Tran Van Nam with 2 × Mineral water at 15,000; 103 Le Thi Hanh with 2 × Saigon beer. Linh's account is created and signed in off camera.
**Length:** 1:21. File `R4-ask-the-owner.webm`.

| # | At | Step (caption) | Notice |
|---|---|---|---|
| 1 | 0:02 | Linh (receptionist): 101 is a regular; Mai agreed 10,000 a bottle | The receptionist's nav has no Setup, Reports or Accounts. |
| 2 | 0:10 | Ask to reprice → 10,000, with a reason | Her buttons read "Ask to reprice" and "Ask to take off", not Reprice and Void. |
...
| 5 | 0:38 | Mai: the Reports link has a badge | The count of requests is the notification; nothing leaves the app. |
...
| 9 | 0:59 | Linh: 101's bill | The old line is struck through with the reason; a new line is at 2 × 10,000. |
