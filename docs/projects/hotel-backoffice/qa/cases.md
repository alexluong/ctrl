...
| S3-30 | D-12 (f) void double-click | two presses in one tick (since G3: on the reason dialog's confirm) | voided once, no refusal | e2e:expenses.spec "S3-30" | 69899bc **fail** (**N31**: the Ask dialog's confirm has no busy guard; the second void is refused "Khoản chi này đã được huỷ.") |
