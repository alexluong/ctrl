...
**Proposed:** D-11 auth — revised lean: app-owned username/password v1 (product's D-20 answers), OIDC later · D-20 person PII outside the event log (id refs + mutable tables + tombstone erasure; Decree 13/2023). D-10 folded into D-12.
