# Project: Hotel Booking Management (back office)

Semi-professional (not full professional). Booking/reservation management back-office app for a hotel.

## Core idea

- Back-office tool: manage bookings for a hotel
- Scope beyond that TBD — needs discovery

## Notes

- Best fit for the **"Go at larger scope/scale" learning goal** — real domain modeling (reservations, room inventory, rates, calendars), real users, real data integrity concerns
...
- Current process: paper? Excel? existing PMS?
